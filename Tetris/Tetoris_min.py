...
class TetrisEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if(strin == "gameover"):
            ...
            self.reward += (0.25 if piece_changed else 0.0)# +0.25 reward for placing a piece
...
TIMESTEPS = 1e6;
model.learn(total_timesteps=TIMESTEPS, reset_num_timesteps=False, tb_log_name=f"TetoPPO", progress_bar=False)
